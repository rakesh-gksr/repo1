...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               ...
                               "test_advPiping_comment",  # report_file_name_prefix
...
def test_advPiping_comment_multiChoice(create_survey):
...
def test_advPiping_comment_dropdown(create_survey):
    driver, mySurvey, report = create_survey
    # then start the normal test
...
def test_advPiping_comment_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_comment_textAB(create_survey):
    driver, mySurvey, report = create_survey
    ...
    try:
        ...
        mySurvey.myQuestion.enter_textAB_textbox(2, "{{Q1}}")  # for some reason it eats one of the opening curly braces O_O
        mySurvey.myQuestion.click_question_save_from_edit_tab()
        ex = mySurvey.myDesign.click_preview_button()
        report.add_report_record(ReportMessageTypes.TEST_STEP, "Click the preview button",
                                 "Clicks preview button, in order to verify theme in preview window.",
...
def test_advPiping_comment_imageAB(create_survey):
    driver, mySurvey, report = create_survey
