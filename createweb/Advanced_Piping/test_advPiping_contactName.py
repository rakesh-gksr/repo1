...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingContactName/",  # report_relative_location
                               "test_advPiping_contactName",  # report_file_name_prefix
...
def test_advPiping_contactName_multiChoice(create_survey):
...
def test_advPiping_contactName_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_contactName_imageAB(create_survey):
    driver, mySurvey, report = create_survey
