...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingDateTimeInternational/",  # report_relative_location
                               "test_advPiping_dateTimeInternational",  # report_file_name_prefix
...
def test_advPiping_dateTimeInternational_multiChoice(create_survey):
...
def test_advPiping_dateTimeInternational_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_dateTimeInternational_imageAB(create_survey):
    driver, mySurvey, report = create_survey
