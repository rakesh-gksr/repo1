...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingMenuMatrix/",  # report_relative_location
                               "test_advPiping_menuMatrix",  # report_file_name_prefix
...
def test_advPiping_menuMatrix_multiChoice(create_survey):
...
def test_advPiping_menuMatrix_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_menuMatrix_imageAB(create_survey):
    driver, mySurvey, report = create_survey
