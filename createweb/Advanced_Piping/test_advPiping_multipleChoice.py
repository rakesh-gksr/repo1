...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingMultipleChoice/",  # report_relative_location
                               "test_advPiping_multipleChoice",  # report_file_name_prefix
...
def test_advPiping_multipleChoice_multiChoice(create_survey):
...
def test_advPiping_multipleChoice_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multipleChoice_imageAB(create_survey):
    driver, mySurvey, report = create_survey
