...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingMultipleTextboxes/",  # report_relative_location
                               "test_advPiping_multipleTextboxes",  # report_file_name_prefix
...
def test_advPiping_multiTextbox_multiChoice(create_survey):
...
def test_advPiping_multiTextbox_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_multiTextbox_imageAB(create_survey):
    driver, mySurvey, report = create_survey
