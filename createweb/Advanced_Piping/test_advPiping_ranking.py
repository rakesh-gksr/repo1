...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingRanking/",  # report_relative_location
                               "test_advPiping_ranking",  # report_file_name_prefix
...
def test_advPiping_ranking_multiChoice(create_survey):
...
def test_advPiping_ranking_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_text(create_survey):
    driver, mySurvey, report = create_survey
    ...
    try:
        ...
        mySurvey.myDesign.return_from_frame()
        mySurvey.myDesign.click_preview_next_button()
        ex = mySurvey.myDesign.get_preview_text(1, questionAnswer)
        report.add_report_record(ReportMessageTypes.TEST_STEP, "Verify Question Title Piped from Q1",
                                 "Verify question title is the same that we entered in Q1.",
                                 ex,
                                 True,
...
def test_advPiping_ranking_image(create_survey):
    driver, mySurvey, report = create_survey
    ...
    try:
        ...
        mySurvey.myDesign.return_from_frame()
        mySurvey.myDesign.click_preview_next_button()
        ex = mySurvey.myDesign.get_preview_image_label(1, questionAnswer)
        report.add_report_record(ReportMessageTypes.TEST_STEP, "Verify Question Title Piped from Q1",
                                 "Verify question title is the same that we entered in Q1.",
                                 ex,
                                 True,
...
def test_advPiping_ranking_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_ranking_imageAB(create_survey):
    driver, mySurvey, report = create_survey
