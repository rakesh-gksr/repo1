...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingMatrixSinglePageMode/",  # report_relative_location
                               "test_advPiping_matrix_singlePageMode",  # report_file_name_prefix
...
def test_advPiping_matrix_singlePageMode_multiChoice(create_survey):
...
def test_advPiping_matrix_singlePageMode_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_matrix_singlePageMode_imageAB(create_survey):
    driver, mySurvey, report = create_survey
