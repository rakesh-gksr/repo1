...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvPipingSingleTextboxes/",  # report_relative_location
                               "test_advPiping_singleTextboxes",  # report_file_name_prefix
...
def test_advPiping_singleTextbox_multiChoice(create_survey):
...
def test_advPiping_singleTextbox_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_advPiping_singleTextbox_imageAB(create_survey):
    driver, mySurvey, report = create_survey
