...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAccountBasicAddNewQuestion/",  # report_relative_location
                               "test_account_basic_addNewQuestion",  # report_file_name_prefix
...
def test_account_basic_addNewQuestion_default(create_survey):
...
def test_account_basic_addNewQuestion_multipleChoice(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
    ...
    try:
        ...
        mySurvey.myDesign.wait_collectorPage()
        mySurvey.myDesign.click_designSurvey_tab()
        mySurvey.myCreate.add_a_new_question("upgradeMenuMatrix", "qmd")
        ex = mySurvey.myLogic.verify_upgradeNotify("MenuMatrix")
        report.add_report_record(ReportMessageTypes.TEST_STEP,
                                 "Verify upgrade notification for menu matrix feature",
                                 "verifies select user gets upgrade notification for Menu Matrix type question",
                                 ex,
                                 True,
                                 not ex,
                                 driver)
        assert ex, "Failed to verify upgrade notification for Menu Matrix."
    except:
        report.add_report_record(ReportMessageTypes.TEST_STEP, "Exception occurred during test setup",
                                 traceback.format_exc(),
                                 False,
...
def test_account_basic_addNewQuestion_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_NPS(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_Image(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_textAB(create_survey):
    driver, mySurvey, report = create_survey
...
def test_account_basic_addNewQuestion_imageAB(create_survey):
    driver, mySurvey, report = create_survey
