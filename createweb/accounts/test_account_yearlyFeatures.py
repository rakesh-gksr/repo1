...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAccountsYearlyFeatures/",  # report_relative_location
                               "test_accounts_yearlyFeatures",  # report_file_name_prefix
                               "Verify Select Yearly Account Features and Upgrades",  # test_suite_title
...
def test_accounts_yearlyVerifyAll(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Test all features that Select Yearly Account can use.")
    try:
        ...
        mySurvey.myQuestion.click_piping_menu()
