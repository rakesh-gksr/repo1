...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAccountsGoldAddNewQuestion/",  # report_relative_location
                               "test_accounts_gold_addNewQuestion",  # report_file_name_prefix
...
def test_accounts_gold_addNewQuestion_default(create_survey):
...
def test_accounts_gold_addNewQuestion_multipleChoice(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_dropdown(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_matrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_menuMatrix(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_ranking(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_NPS(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_singleTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_multiTextbox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_commentBox(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_contactInfo(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_dateTime(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_text(create_survey):
    driver, mySurvey, report = create_survey
...
def test_accounts_gold_addNewQuestion_Image(create_survey):
    driver, mySurvey, report = create_survey
