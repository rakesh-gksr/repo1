...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchDestPageDelete/",  # report_relative_location
                               "test_advBranch_destPageDelete",  # report_file_name_prefix
                               "verify deleting destination page",  # test_suite_title
...
def test_advBranch_destPageDelete(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "verify deleting destination page.")
    try:
