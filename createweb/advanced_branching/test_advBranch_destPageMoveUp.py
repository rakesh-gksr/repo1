...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchDestPageMoveUp/",  # report_relative_location
                               "test_advBranch_destPageMoveUp",  # report_file_name_prefix
                               # test_suite_title
                               "Test reordering pages after adding rules- reorder skip logic destination page below conditional page",
...
def test_advBranch_destPageMoveUp(create_survey):
