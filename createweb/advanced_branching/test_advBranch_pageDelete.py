...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchPageDelete/",  # report_relative_location
                               "test_advBranch_pageDelete",  # report_file_name_prefix
                               "Test deleting page which has branching condition applied",  # test_suite_title
...
def test_advBranch_pageDelete(create_survey):
    ...
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Test deleting page which has branching condition applied.")
    try:
