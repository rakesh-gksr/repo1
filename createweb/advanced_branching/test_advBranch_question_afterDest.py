...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchQuestionAfterDest/",  # report_relative_location
                               "test_advBranch_question_afterDest",  # report_file_name_prefix
                               "basic:Test reordering questions after adding rules- move below skip logic destination page",  # test_suite_title
...
def test_advBranch_question_afterDest(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(
        ReportMessageTypes.TEST_CASE,
        "basic:Test reordering questions after adding rules- move below skip logic destination page.")
    try:
        ...
        mySurvey.myLogic.moveQuestion(4, 1)
