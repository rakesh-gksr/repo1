...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchRanking/",  # report_relative_location
                               "test_advBranch_ranking",  # report_file_name_prefix
                               "Test branching based on the response to ranking question",  # test_suite_title
...
def test_advBranch_ranking(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Test branching based on the response to ranking question.")
    try:
        ...
        ex = mySurvey.myLogic.verify_advanced_branching(
            ["ranking", "ranking"], [1, 1], [(1, 2), (2, 1)], "end_survey", "That's the end of the preview!")
        ...
        mySurvey.myDesign.switch_to_preview_iframe()
        ex = mySurvey.myLogic.verify_advanced_branching(
            ["ranking", "ranking"], [1, 1], [(1, 1), (2, 3)], "end_survey", "That's the end of the preview!")
        ex = not ex
