...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchRestore/",  # report_relative_location
                               "test_advBranch_restore",  # report_file_name_prefix
                               "Test restoring questions after adding rules-restore deleted question on the same page",  # test_suite_title
...
def test_advBranch_restore(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Test restoring questions after adding rules-restore deleted question on the same page.")
    try:
