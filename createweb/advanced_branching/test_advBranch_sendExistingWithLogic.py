...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchSendExistingWithLogic/",  # report_relative_location
                               "test_advBranch_SendExistingWithLogic",  # report_file_name_prefix
                               "verify editing existing survey maintains advanced branching with basic logic sent to another user",  # test_suite_title
...
def test_advBranch_sendExistingWithLogic(create_survey):
