...
to account without branching FF.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchTransferSurveyToAnotherAccountWithFF",
                               # report_relative_location
                               "test_advBranch_transferSurveyToAnotherAccountWithFF",
                               ...
                               ("verify deleting rule by deleting source answer choice deletes branching logic and "
                                "check transferring this survey to account without branching FF"),
...
def test_advBranch_transferSurveyToAnotherAccountWithFF(create_survey, test_info):
