...
from dynamic_tests.dynamic_tests_predicates_config import matrix_rating_scal_qtype_predicates, survey_dict
import traceback
import pytest
...
def pre_setup_survey(mySurvey, driver, report):
    ...
    survey_info = survey_dict["matrix_rating_scale_with_no_weights"]
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchVerifyQTypeMatrixRatingScaleWithWeightsPredicates/",
                               # report_relative_location
                               "test_advBranch_verifyQTypeMatrixRatingScaleWithWeightsPredicates",
...
@pytest.mark.IB
@pytest.mark.C281051
@pytest.mark.parametrize("test_info", matrix_rating_scal_qtype_predicates,
                         ids=[dict["predicate_label"] for dict in matrix_rating_scal_qtype_predicates])
def test_advBranch_verifyQTypeMatrixRatingScaleWithWeightsPredicates(create_survey, test_info):
    """
     Description :
