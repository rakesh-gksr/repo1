...
def pre_setup_survey(mySurvey, driver, report):
    ...
    survey_info = survey_dict["matrix_rating_scale"]
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchVerifyQTypeMatrixSingleRowRatingScalPredicates/",
                               # report_relative_location
                               "test_advBranch_verifyQTypeMatrixSingleRowRatingScalPredicates",
...
def test_advBranch_verifyQTypeMatrixSingleRowRatingScalPredicates(create_survey, test_info):
    """
     Description :
