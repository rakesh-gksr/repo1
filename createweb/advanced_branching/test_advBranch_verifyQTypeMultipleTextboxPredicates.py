...
from dynamic_tests.dynamic_tests_predicates_config import multiple_textbox_predicates, survey_dict
import traceback
import pytest
...
def pre_setup_survey(mySurvey, driver, report):
    ...
    survey_info = survey_dict["multiple_textbox"]
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchVerifyQTypeMultipleTextboxPredicates/",
                               # report_relative_location
                               "test_advBranch_verifyQTypeMultipleTextboxPredicates",
...
@pytest.mark.IB
@pytest.mark.C281056
@pytest.mark.parametrize("test_info", multiple_textbox_predicates,
                         ids=[dict["predicate_label"] for dict in multiple_textbox_predicates])
def test_advBranch_verifyQTypeMultipleTextboxPredicates(create_survey, test_info):
    """
    Description :
