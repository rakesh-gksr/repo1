...
from dynamic_tests.dynamic_tests_predicates_config import single_textbox_predicates, survey_dict
import traceback
import pytest
...
def pre_setup_survey(mySurvey, driver, report):
    ...
    survey_info = survey_dict["single_textbox"]
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestAdvBranchVerifyQTypeSingleTextboxPredicates/",
                               # report_relative_location
                               "test_advBranch_verifyQTypeSingleTextboxPredicates",
...
@pytest.mark.IB
@pytest.mark.C281055
@pytest.mark.parametrize("test_info", single_textbox_predicates,
                         ids=[dict["predicate_label"] for dict in single_textbox_predicates])
def test_advBranch_verifyQTypeSingleTextboxPredicates(create_survey, test_info):
    """
        Description :
