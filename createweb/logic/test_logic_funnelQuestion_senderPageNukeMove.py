...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestLogicFunnelQuestionSenderPageNukeMove/",  # report_relative_location
                               "test_logic_funnelQuestion_senderPageNukeMove",  # report_file_name_prefix
                               "Test delete a page with sender questions - moving questions to following page",  # test_suite_title
                               ("This test adds 2 questions seperated bya blank page "
                                " Test then deletes sender page and moves sender question downand doesn't"
...
def test_logic_funnelQuestion_senderPageNuke(create_survey):
    ...
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Test delete a page with sender questions - moving questions to following page.")
    try:
        ...
        mySurvey.myCreate.nuke_page_move_questions(1)
        # time.sleep(5)
