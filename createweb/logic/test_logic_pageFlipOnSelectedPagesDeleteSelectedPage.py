...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               ...
                               "To verify page Flip after applying logic and deleting selected page.",  # test_suite_title
                               ("This test verifies remove page flip on selected pages"
                                " post deleting selected page"),  # test_suite_description
                               "utf-8",  # file_encoding
...
@pytest.mark.IB
@pytest.mark.C212989
def test_logic_pageFlipOnSelectedPagesDeleteSelectedPages(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "To verify page Flip after applying"
                                                           " logic and deleting selected page.")
    try:
        ...
        mySurvey.myLogic.pageRandom_flipPages_selected([2, 4, 5], 5)
        ...
        mySurvey.myLogic.click_PageRandomization()
        ex = mySurvey.myLogic.pageRandom_flipPages_verifySelected([2, 4], 4)
        report.add_report_record(ReportMessageTypes.TEST_STEP,
                                 "Verify that page flip selected pages after deleting selected page",
                                 ...
                                 not ex,
                                 driver)
        assert ex, "Failed to verify correct page list shown for page flip option post deleting selected page."
