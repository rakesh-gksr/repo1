...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestLogicPageFlipSelectedWithQuestionPiping/",  # report_relative_location
                               "test_logic_pageFlip_selected_with_question_piping",  # report_file_name_prefix
                               "To verify Page Randomization does not works with Piping when Seleted Survey"
                               " pages are Flipped",  # test_suite_title
                               ("This test verify Page Randomization does not works with Piping when Seleted Survey "
                                "pages are Flipped ."),  # test_suite_description
                               "utf-8",  # file_encoding
