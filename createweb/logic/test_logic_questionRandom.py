...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestLogicQuestionRandom/",  # report_relative_location
                               "test_logic_questionRandom",  # report_file_name_prefix
                               ...
                               ("This test applies page logic "
                                ...
                                " to randomize the survey questions."),  # test_suite_description
                               "utf-8",  # file_encoding
...
def test_logic_questionRandom(create_survey):
    ...
    try:
        ...
        ex = mySurvey.myLogic.checkForRandomness(5)
