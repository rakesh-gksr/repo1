...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               ...
                               "test_logic_questionRandomSelected_multipleQuestion",  # report_file_name_prefix
                               "verify Randomizing selected Questions",  # test_suite_title
                               ("This test applies page logic "
                                " question randomization on multiple question types "
...
def test_logic_questionRandomSelected_multipleQuestion(create_survey):
    ...
    try:
        ...
        driver.refresh()
        # change question 1 type to dropdown and verify
        mySurvey.myQuestion.click_on_question_to_edit(1)
        mySurvey.myQuestion.changeQType("Dropdown")
        mySurvey.myQuestion.click_question_save_from_edit_tab()

        mySurvey.myQuestion.click_on_question_to_edit(1)
        ex = mySurvey.myQuestion.verifyQuestionSwitchState(q_title, answer_rows, ["multipleChoice"])
        ...
        # apply question randomization on selected questions
        ...
        # verify question randomization by taking survey in preview mode
