...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               ...
                               "verify removing flipping Selected Questions",  # test_suite_title
                               ("This test applies removing of flip selected questions"),  # test_suite_description
                               "utf-8",  # file_encoding
...
def test_logic_questionVerifyRamoveFlipSelected(create_survey):
    ...
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Verify removal of flip selected question.")
    try:
        ...
        ex = mySurvey.myLogic.checkQuestionsRandomizedIconSelected(0)
