...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestLogicSeperateBlockNewPipe/",  # report_relative_location
                               "test_logic_seperateBlock_newPipe",  # report_file_name_prefix
                               "verify inserting piping between blocks",  # test_suite_title
                               ("This test adds pages 1 and 2 to seperate blocks "
...
def test_logic_existingBlock_newPipe(create_survey):
    ...
    report.add_report_record(ReportMessageTypes.TEST_CASE, "verify inserting piping across blocks.")
    try:
        # page1
