...
# -*- coding: utf-8 -*-
"""
verify adding slider question from 'add a new question button' dropdown.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestSliderQTypeAddQuesFromAddNewQuestionDropdown/",  # report_relative_location
                               "test_sliderQType_addQuesFromAddNewQuestionDropdown",  # report_file_name_prefix
                               # test_suite_title
                               "verify adding slider question from 'add a new question button' dropdown.",
                               "Test to verify adding slider question from 'add a new question button' dropdown.",
...
@pytest.mark.IB
@pytest.mark.C284099
def test_sliderQType_addQuesFromAddNewQuestionDropdown(create_survey):
    ...
    report.add_report_record(
        ...
        "verify adding slider question from 'add a new question button' dropdown.")
    try:
        mySurvey.myCreate.add_a_new_question("Slider")
