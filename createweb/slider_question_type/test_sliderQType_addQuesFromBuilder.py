...
# -*- coding: utf-8 -*-
"""
verify adding slider question from builder by clicking.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestSliderQTypeAddQuesFromBuilder/",  # report_relative_location
                               "test_sliderQType_addQuesFromBuilder",  # report_file_name_prefix
                               # test_suite_title
                               "verify adding slider question from builder by clicking",
                               "verify adding slider question from builder by clicking",  # test_suite_description
                               "utf-8",  # file_encoding
...
@pytest.mark.IB
@pytest.mark.C284098
def test_sliderQType_addQuesFromBuilder(create_survey):
