...
# -*- coding: utf-8 -*-
"""
verify copying slider with position to the right.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestSliderQuestionVerifyCopySliderWithPositionRight/",  # report_relative_location
                               "test_sliderQuestionVerifyCopySliderWithPositionRight",  # report_file_name_prefix
                               # test_suite_title
                               "verify copying slider with position to the right",
                               "Test to verify copying slider with position to the right",  # test_suite_description
                               "utf-8",  # file_encoding
...
@pytest.mark.IB
@pytest.mark.C284510
def test_sliderQuestionVerifyCopySliderWithPositionRight(create_survey):
    driver, mySurvey, report = create_survey

    report.add_report_record(ReportMessageTypes.TEST_CASE, "verify copying slider with position to the right")
    try:
        ...
        mySurvey.myQuestion.selectSliderStartPosition('right')
        ...
        report.add_report_record(ReportMessageTypes.TEST_STEP,
                                 "Verify that copied question is saved with slider position in right",
