...
# -*- coding: utf-8 -*-
"""
verify adding star rating question from builder by clicking.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestStarQTypeAddQuesFromBuilder/",  # report_relative_location
                               "test_StarQType_addQuesFromBuilder",  # report_file_name_prefix
                               # test_suite_title
                               "verify adding star rating question from builder by clicking",
                               "verify adding star rating question from builder by clicking",  # test_suite_description
                               "utf-8",  # file_encoding
...
@pytest.mark.IB
@pytest.mark.C812360
def test_StarQType_addQuesFromBuilder(create_survey):
