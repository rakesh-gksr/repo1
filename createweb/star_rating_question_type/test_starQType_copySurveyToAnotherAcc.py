...
# -*- coding: utf-8 -*-
"""
Verify copying survey with star to another account.
...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestStarQTypeCopySurveyToAnotherAcc/",  # report_relative_location
                               "test_starQType_copySurveyToAnotherAcc",  # report_file_name_prefix
                               # test_suite_title
                               "Verify copying survey with star to another account.",
                               "Test to verify copying survey with star to another account.",
...
@pytest.mark.BVT
@pytest.mark.C812392
def test_starQType_copySurveyToAnotherAcc(create_survey):
