...
def get_report(request):
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestVerifyContinueEditingButton",  # report_relative_location
                               "test_verifyContinueEditingButton",  # report_file_name_prefix
                               "Verify the \"Continue Editing\" link in the Final state of the survey",
                               # test_suite_title
                               "Test to Verify the \"Continue Editing\" link in the Final state of the survey",
...
def test_verify_continue_editing_button(create_survey):
    driver, mySurvey, report = create_survey

    report.add_report_record(ReportMessageTypes.TEST_CASE, "Verify the \"Continue Editing\" link in the Final "
                                                           "state of the survey")
    try:
        ...
        ex = mySurvey.myCreate.check_continue_editing_link(is_clicked=True)
        ...
        create_utils.wait_page_back_loaded(driver)
        ex = "/create/?sm=" in driver.current_url
