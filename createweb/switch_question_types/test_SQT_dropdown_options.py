...
def get_report(request):
    ...
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestSQTDropdownOptions/",  # report_relative_location
                               "test_SQT_dropdown_options",  # report_file_name_prefix
                               "Verify switching from multiple choice to dropdown ",  # test_suite_title
                               ("This test suite adds a multiple choice question and switches it to a dropdown question   "
...
def test_SQT_dropdown_options(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "Verify switching from multiple choice to dropdown")
    try:
