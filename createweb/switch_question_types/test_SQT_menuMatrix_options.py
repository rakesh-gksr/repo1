...
def get_report(request):
    ...
    report = reporting_wrapper("Create",  # report_feature_name
                               "TestSQTMenuMatrixOptions/",  # report_relative_location
                               "test_SQT_menuMatrix_options",  # report_file_name_prefix
                               "verify switching from menu matrix to matrix question ",  # test_suite_title
                               ("This test suite adds a a menu matrix question and switches it to a matrix question   "
...
def test_SQT_menuMatrix_options(create_survey):
    driver, mySurvey, report = create_survey

    # then start the normal test
    report.add_report_record(ReportMessageTypes.TEST_CASE, "verify switching from menu matrix to matrix question")
    try:
